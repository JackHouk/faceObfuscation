...
def cnn_model_fn(features, labels, mode):
   ...
   # flat = tf.reshape(input_layer, -1, dims * dims * 10)
    ...
    loss = loss = tf.reduce_mean(tf.square(square - labels))
